This tool assists in the extraction of hero, unit and item information from
Valves Dota 2

Models
======
The model files were automatically created by JAXB with the CC-XJC-Plugin
(http://ccxjc.sourceforge.net).
